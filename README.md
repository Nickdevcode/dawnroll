...
- **Engolir o jardim:** maior ainda, a bola **arranca do chão** cogumelos, flores, pedras, troncos e os objetos perdidos, que voam e grudam nela (e engordam bem mais que bosta). O que ainda é grande demais só faz a bola bater, e o jogo avisa quantos cm faltam. O anão de jardim pede uns 22 cm.
- **Bichos grudam:** tatuzinho enrolado, tesourinha, lacraia, lagarta, lesma, vaquinha, bicho-pau e tanajura pousada grudam quando a bola é grande o bastante pra eles.
- **Equilibrista:** com esse poder, aperte `Q` perto da bola e o besouro pula em cima dela e sai andando, com a bola rolando embaixo dele como num circo. Dura 7 s (11 s no ★★), depois ele desce e o poder recarrega. Apertar de novo ou pular também desce.
...
| 🥗 **Quanto rende** | Tamanho (3 por cm) + **variedade** (4 por tipo diferente de coisa na bola até o 10º tipo, 2 daí em diante) + montinho fresquinho (6 cada) + coisa rara (5 cada: trevo de quatro folhas, bicho-pau, anão...) + pedidos cumpridos. Variedade pesa de propósito: é o que faz valer explorar o jardim |
| ⭐ **Nível** | O besouro fica **mais forte** (+4% de força por nível) e **mais rápido** (+2% de velocidade), com teto no nível 11 (+40% e +20%). A primeira bola já sobe de nível. Do nível 2 ao 8 cada nível pode liberar poderes novos |
...
|---|---|---|---|
| 🧲 **Bola grudenta** | Montinho e tralha grudam de mais longe | Quase o dobro do alcance | 1 |
| 🔥 **Sangue quente** | Empurrando sem parar, esquenta e acelera (até +35% de força e +30% de velocidade) | Esquenta mais rápido, até +50% / +45% | 1 |
| 🛡️ **Casca de lama** | A poça quase não derrete a bola (−70%), a água freia menos e a lama engorda 2,5× | −90%, lama 3,5× | 1 |
| 👃 **Faro** | Marcadores nos montinhos fresquinhos mais perto; na hora 3 viram fresquinhos e passam a nascer mais | Mais 3 e nascem ainda mais | 2 |
| 🤸 **Equilibrista** | Poder de apertar: sobe na bola e anda em cima dela por 7 s, depois recarrega (16 s) | 11 s em cima, recarga de 10 s | 2 |
| 🥷 **Sorrateiro** | Vira e arranca bem mais rápido com bola pequena (perde o efeito até ~12 cm) | Vale até ~17 cm | 3 |
| 🦏 **Chifrudo** | Arranca coisa até 25% maior que a bola, mas vira mais devagar | Até 45% maior | 4 |
| ⛰️ **Ladeira abaixo** | Morro abaixo a bola embala sozinha, e o embalo arranca coisa até 20% maior | Embala mais, até 35% | 5 |
| 💥 **Trombada** | Bater forte em coisa grande demais derruba tralha dela (pétala da flor, lasca da pedra, graveto do tronco) | Qualquer batidinha, o dobro de tralha | 5 |
| 🎨 **Curioso** | Cada tipo novo de coisa na bola dá um estirão de crescimento (+4% do volume) | +7% | 6 |
...
│   ├── Scenery.ts          # horizonte fixo + jardim atual + o da próxima rodada (montado aos poucos)
│   ├── gardenLayout.ts     # o sorteio de um jardim inteiro a partir de uma semente (um objeto por passo)
...
- **Folhagem só pra câmera:** pétala, folha e caule ganham cascos num grupo de colisão só da câmera (`Groups.CAMERA`): bola e besouro atravessam, e a lente só não pode *terminar* dentro deles (passar na frente não puxa a câmera, senão ela ficaria pulando a cada flor).
- **Colisão automática:** cada peça do modelo é testada contra os colisores feitos à mão (`projectPoint`); o que fica mais de 20% de fora ganha um casco convexo da própria peça. Peça comprida (caule, cabo) vira uma corrente de cascos ao longo do eixo; dezenas de peças miúdas (escamas da pinha, fiapos do dente-de-leão) viram um casco por grupo que se encosta.
- **Jardim novo sem engasgo:** o sorteio é um gerador (`function*`) com um `yield` por objeto (cada cogumelo, mil tufos de grama). O jardim da próxima rodada começa a nascer assim que uma rodada começa, com ~2,5 ms por quadro (10 ms no menu, 8 ms no enterro), com os colisores desligados até a troca. Os bichos, o passo mais pesado, só nascem quando a bola cai na toca. As esferas de massinha deformadas (`claySphere`) ficam num cache limitado e saem como cópia: montar os bichos caiu de ~160 para ~60 ms.
- **Mesma semente, mesmo jardim:** tudo sai de sorteios derivados de uma semente só (`mixSeed`), um por assunto. Em desenvolvimento, `?seed=123` na URL repete um jardim para reproduzir bug.
- **Arrancar sem perder o lote:** flores, cogumelos, pedras e troncos continuam fundidos no lote estático. O lote guarda em que trecho do índice cada um caiu; "arrancar" troca esses triângulos por triângulos degenerados. Vale pra todo passe (cor, sombra, AO, profundidade) sem shader especial, e o draw call continua um só. O colisor só é desligado (`setEnabled(false)`), não destruído; o jardim inteiro some junto quando a rodada troca (um corpo fixo por jardim).
...
- **Muito bicho, poucos draw calls:** cada parte de cada espécie (corpo, asa, pata...) é um `InstancedMesh` com as matrizes calculadas na CPU; parte sem ninguém visível desliga sozinha, e só os indivíduos na visão da câmera são desenhados. Antes eram ~26 draw calls de fauna no seco e ~31 na chuva; a fauna nova soma uns +11 no seco (até ~22 com o beija-flor, uma aranha fugindo e os bichos de debaixo da pedra) e mais 5 na chuva (lesma e revoada). Medido o quadro inteiro (todos os passes), o jogo foi de ~740–790 pra ~855–895 draw calls com objetos e fauna novos, sem mudar o tempo de quadro no PC de teste.
